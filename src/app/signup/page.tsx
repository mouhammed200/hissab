...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[var(--bg-primary)]">
      {/* Background Orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-[128px] animate-pulse-glow" />
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-emerald-500/20 rounded-full blur-[128px] animate-pulse-glow" style={{ animationDelay: '1.5s' }} />
      ...
      <div className="relative z-10 w-full max-w-md p-8 glass rounded-2xl animate-slide-up glow-accent m-4">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-1.5" htmlFor="companyName">Company Name</label>
            <input
              id="companyName"
              type="text"
              value={companyName}
